window.addEventListener('load', function()
{
        ...
        draw(context) {
            ...
            if (this.game.gameOver) {
                ...
                if (this.game.score > this.game.winningScore){
                    message1 = 'So Wondrous!';
                    message2 = 'You Are SuperSuper!';
                } else {
                    message1 = 'Blazes!';
                    message2 = 'You Are Noob!';
                }
                context.font = '50px ' + this.fontFamily;
                context.fillText(message1, this.game.width * 0.5, this.game.height * 0.5 - 25);
    ...
    class Game {
        constructor(width, height){
            ...
            this.ui = new UI(this);
            this.sound = new SoundCountroller();
